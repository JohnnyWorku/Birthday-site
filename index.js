...
class Birthday {
  ...
  update(delta) {
    ...
    for (let firework of this.fireworks) firework.update(delta); // if enough time passed... create new new firework
...
playSong = () => {
  if (song.paused) {
    ...
    songBtn.style.animation = "none";
  } else {
    song.pause();
    songBtn.textContent = "Play Song";
    songBtn.style.animation = "bounce 3s infinite";
  }
};
